...
public class StatisticsApp extends Application {
    ...
    public static void main(String[] args) {
        launch(args);
        //System.out.println("\"2016-".matches("^\"20.*"));
    }

    @Override
    public void start(Stage primaryStage) throws Exception {
        floatFormat = new DecimalFormat("##.###");
        FxSettings.xMax = 20160901;
        FxSettings.xMin = 20160101;
        FxSettings.yMax = 10000;
        FxSettings.yMin = 0;
    ...
    private void redraw(double zoomFactor, Group root) {
        ...
        List<Point2D> mathPoints = new TransactionsReader("/kontoutskrift.csv").read();
