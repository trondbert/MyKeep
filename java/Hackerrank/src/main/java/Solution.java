...
public class Solution {
    ...
    public Solution(Supplier<String> linesSupplier) {
    ...
    public static void main(String[] args) {
        ...
        new Solution(supplierFromStdin).solve().forEach(System.out::println);
    }
...
class Node {
    ...
    public int tentativeCost = Solution.infinitish;
...
class Dijkstra {
    ...
    private Solution caller;

    Dijkstra(Solution caller) {
        this.caller = caller;
    }
